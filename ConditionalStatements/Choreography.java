...
public class Choreography {
    public static void main(String[] args) {
        ...
        double percentStepsPerDay = Math.ceil((((steps * 1.0 / days) / steps)) * 100);
        ...
        if (percentStepsPerDay <= 13) {
            ...
            System.out.printf("No, they will not succeed in that goal! Required %.2f%% steps to be learned per day.", percentStepsPerDancer);
        }
